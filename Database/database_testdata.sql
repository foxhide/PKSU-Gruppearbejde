...
INSERT INTO users (userName, password, firstName, lastName, admin, phoneNum, email, active, needsApproval)
	VALUES ("johan_the_man","1000:40fMt+KjU9BuxnAzB30T7iD7AxGRn08Z:Iumz5ozS0aTrq+OzbkugeXsl1pNIWoiT","Johan", "Damgaard", 1, "012345678","johan@stengade.dk",1,0);
-- password for andreas_PKSU is 'andreasercool'
INSERT INTO users (userName, password, firstName, lastName, admin, phoneNum, email, active, needsApproval)
	VALUES ("andreas_PKSU","1000:WJ5Ayds/Y/ppFJQUabbWiBZqxF+EDQg4:+8y/SwqlBVsAww1mvN2wC9a5JIKxhBP7","Andreas", "Olsen", 1, "012345678","andreas@stengade.dk",1,0);
-- password for stephan_kerbal is 'kerbaltillinux'
INSERT INTO users (userName, password, firstName, lastName, admin, phoneNum, email, active, needsApproval)
	VALUES ("stephan_kerbal","1000:9Fmy1xBY2YVGGNcNcSVuN9SZoukPehdL:0hVUB/TjHtnGIqpl1CXggrkcDkciHwpW","Stephan", "Lorenzen", 1, "012345678","stephan@stengade.dk",1,0);
-- password for bill123 is 'kerbal'
INSERT INTO users (userName, password, firstName, lastName, admin, phoneNum, email, active, needsApproval)
	VALUES ("bill123","1000:isl+vj+KMCRz1AB3fWiB5g1z0ESC/JKe:IJ0ibpJ8nm5tlxtZhkwN/fCTsORR+vM1","Bill" , "Kerman" , 0, "012345678","bill@kerbal.kb",1,0);
