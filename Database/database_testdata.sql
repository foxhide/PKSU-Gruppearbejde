...
INSERT INTO groups (groupName) VALUES ("ConcertBookers");
INSERT INTO groups (groupName) VALUES ("PokerPlayers");

INSERT INTO users (userName, password, realName, email, active, needsApproval) 
	VALUES ("johan_the_man","johanersej","Johan","johan@stengade.dk",1,0);
INSERT INTO users (userName, password, realName, email, active, needsApproval) 
	VALUES ("andreas_PKSU","andreasercool","Andreas","andreas@stengade.dk",1,0);
INSERT INTO users (userName, password, realName, email, active, needsApproval) 
	VALUES ("stephan_kerbal","kerbaltillinux","Stephan","stephan@stengade.dk",1,0);
...
INSERT INTO eventtypefields 
	(eventTypeId, dbFieldName, fieldDescription, requiredField, fieldTypeId) 
	VALUES (2, "band","band-name",1,2);
...
INSERT INTO concert (eventId, band) VALUES (1, "muse");
