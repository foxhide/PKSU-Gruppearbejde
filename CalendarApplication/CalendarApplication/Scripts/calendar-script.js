...
// NB NB -> remember to include the extn. scripts, depending on platform.

//-- Configuration variables --//
var ROUND_VALUE = 30; // Used in the extensions.
...
//-- Helper function for extn. scripts --//

/* Function for rounding a positive number (value) to
   the nearest multiplum of roundToNearest */
function round(value, roundToNearest) {
    var tmp = (value + roundToNearest / 2);
    return tmp - tmp % roundToNearest;
}